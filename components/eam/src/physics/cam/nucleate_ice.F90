...
!              cam_chempkg_is('linoz_mam7_resus_mom_soag_s') .or. &  !kzm ++
!              cam_chempkg_is('linoz_mam5_resus_mom_soag') .or. &  !kzm ++
!              cam_chempkg_is('trop_strat_mam7_resus_mom_s') .or. &  !kzm ++
!              cam_chempkg_is('trop_strat_mam5_resus_mom_soag') .or. &  !kzm ++
